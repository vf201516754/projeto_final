...
<html>
	...
	<div class="ui large top fixed hidden menu">
            <div class="ui container">
                ...
                <a href="painel_subservico" class="active item">Painel subserviços</a>
            </div>
        </div>
                    ...
                    <div class="ui middle aligned center aligned grid">
                            <div class="column style-form-gerar-senha">
                                <h2 class="ui teal image header">
                                    <div class="content">
                                        <h2 class="title-gerar-senha">Painel subserviços</h2>
                                    </div>
                                </h2>
                                <div class="ui large form">
                                    <div class="ui stacked segment">
                                        <div class="atendimento">
                                            ...
                                            <select class="form-control ui dropdown" name="" id="selecionarSubservicoAtendimento">
                                                <option value="">Selecione um subservico</option>
